...
namespace SV.Builder.Domain.Tests.ExerciseSetTests
{
    public class EnduranceSetDurationTests
    {
        ...
        public void RoundLength_Matches()
        {
            ...
            var set = createDefaulEnduranceSet();
        ...
        private EnduranceSet createDefaulEnduranceSet()
        {
            return new EnduranceSet(_expectedDuration);
        }
        ...
        public void MultipleSets_RoundLength_Matches()
        {
            ...
            var exercise = new Exercise("Exercise 1");
            var set = createDefaulEnduranceSet();
            var set2 = createDefaulEnduranceSet();
